...
class Calculator(QWidget):
    def __init__(self):
        ...
        self.b_bs = QPushButton("bs", self)
        self.hbox_zero.addWidget(self.b_bs)

        self.b_0 = QPushButton("0", self)
        self.hbox_zero.addWidget(self.b_0)

        self.b_dot = QPushButton(".", self)
        self.hbox_zero.addWidget(self.b_dot)
        ...
        self.hbox_zero.addWidget(self.b_divide)

        self.b_result = QPushButton("=", self)
        self.hbox_result.addWidget(self.b_result)

        self.b_clr = QPushButton("clr", self)
        self.hbox_result.addWidget(self.b_clr)
