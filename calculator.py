...
class Calculator(QWidget):
    def __init__(self):
        ...
        self.hbox_clr = QHBoxLayout()

        self.vbox.addLayout(self.hbox_input)
        self.vbox.addLayout(self.hbox_first)
        self.vbox.addLayout(self.hbox_second)
        self.vbox.addLayout(self.hbox_result)
        self.vbox.addLayout(self.hbox_clr)
        ...
        self.hbox_second.addWidget(self.b_multiple)
        ...
        self.b_result = QPushButton("Clr", self)
        self.hbox_clr.addWidget(self.b_result)
